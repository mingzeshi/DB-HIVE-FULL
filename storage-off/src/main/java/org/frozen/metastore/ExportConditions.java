...
public class ExportConditions implements Runnable {
	...
	private String parserSQLCon(String conditions) {
	...
	private Map<String, String> readXML(String xmlPath) throws Exception {
