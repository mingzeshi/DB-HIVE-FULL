 ...
 *
 */
public class HiveDataBase<HiveDataSet> {
	...
	private List<HiveDataSet> hiveDataSetList; // mysql表与hive表映射list

	public HiveDataBase() {
	}
	
	public HiveDataBase(String ennameM, String ennameH, String chname, String storage, String description, List<HiveDataSet> hiveDataSetList) {
	...
	public List<HiveDataSet> getHiveDataSetList() {
		return hiveDataSetList;
	}

	public void setHiveDataSetList(List<HiveDataSet> hiveDataSetList) {
		this.hiveDataSetList = hiveDataSetList;
	}
}
