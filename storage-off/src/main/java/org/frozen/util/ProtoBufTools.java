...
import org.frozen.pb.ObjectData.ObjectAttr;
import org.frozen.pb.ObjectData.ObjectBase;
import org.frozen.pb.ObjectData.ObjectBaseAttr;
import org.frozen.pb.ObjectData.ObjectCounter;
import org.frozen.pb.ObjectData.ObjectInfo;
import org.frozen.pb.ObjectData.ObjectInfoAttr;
...
//					list.add(values.getValue());
		...
		public static List<String> getMessagePropsValueFromBase(org.frozen.pb.ObjectData.ObjectBase.Builder obBuilder,
				String fidldName) {
...
//					list.add(values.getValue());
		...
		public static ObjectBaseAttr.Builder getPropsBuilderFromBase(org.frozen.pb.ObjectData.ObjectBase.Builder obBuilder,
				String fidldName) {
			List<org.frozen.pb.ObjectData.ObjectBaseAttr.Builder> propsList = obBuilder.getPropsBuilderList();
			List<String> list = new ArrayList<String>();
//			for (ObjectBaseAttr oia : propsList) {
			for (int i = 0; i < propsList.size(); i ++) {
				if (propsList.get(i).getCode().equalsIgnoreCase(fidldName)) {
...
//					list.add(values.getValue());
		...
		public static String getMessageIDsValueFromBase(org.frozen.pb.ObjectData.ObjectBase.Builder obBuilder,
				String fidldName) {
		...
		public static String getMessageDimsValueFromBase(org.frozen.pb.ObjectData.ObjectBase.Builder obBuilder,
				String fidldName) {
		...
		public static List<String> getMessageValueFromBase(org.frozen.pb.ObjectData.ObjectBase.Builder obBuilder,
				String fieldName) {
			List<String> list = new ArrayList<String>();
			String strRet = "";
		 ...
		 * @return
		 */
		public static org.frozen.pb.ObjectData.ObjectBase.Builder setObjectBaseIdsValue(org.frozen.pb.ObjectData.ObjectBase.Builder obBuilder ,String fieldName,String value){
			
			List<org.frozen.pb.ObjectData.ObjectAttr.Builder> idsBuilderList = obBuilder.getIdsBuilderList();
			
			for(org.frozen.pb.ObjectData.ObjectAttr.Builder obab : idsBuilderList){
				if(obab.getCode().equalsIgnoreCase(fieldName)){
					obab.setValue(value);
					break;
				}
