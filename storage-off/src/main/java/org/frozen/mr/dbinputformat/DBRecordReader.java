...
public class DBRecordReader<T extends DBWritable> extends RecordReader<LongWritable, T> {
	...
	private CustomDBInputFormat.DBInputSplit split;
	 ...
	 * @throws SQLException
	 */
	public DBRecordReader(CustomDBInputFormat.DBInputSplit split, Class<T> inputClass, Configuration conf, Connection conn, DBConfiguration dbConfig, String cond, String[] fields, String table) throws SQLException {
	...
	protected CustomDBInputFormat.DBInputSplit getSplit() {
		return split;
	}
